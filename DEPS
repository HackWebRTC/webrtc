...
vars = {
  ...
  'chromium_revision': '3cb32697975d5135accecc12821de085286b5a76',
}
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@a0d257850a42e6889432e7836a6ae8a1f17cd715',
