...
float Random::Rand<float>() {
  ...
  result = result / (double) 0xFFFFFFFFFFFFFFFEull;
...
double Random::Gaussian(double mean, double standard_deviation) {
  ...
  double u1 = static_cast<double>(NextOutput()) / (double) 0xFFFFFFFFFFFFFFFFull;
  double u2 = static_cast<double>(NextOutput()) / (double) 0xFFFFFFFFFFFFFFFFull;
