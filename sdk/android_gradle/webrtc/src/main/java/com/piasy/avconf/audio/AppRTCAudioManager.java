...
package com.piasy.avconf.audio;
...
import com.piasy.avconf.utils.AppRTCUtils;
...
public class AppRTCAudioManager {
  ...
  private boolean wiredHeadsetReceiverRegistered;
  ...
  private class WiredHeadsetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      Logging.d(TAG, "WiredHeadsetReceiver.onReceive" + AppRTCUtils.getThreadInfo() + ": "
  ...
  private AppRTCAudioManager(Context context, String useSpeakerphone) {
    ...
    Logging.d(TAG, "useSpeakerphone: " + useSpeakerphone);
    ...
    Logging.d(TAG, "defaultAudioDevice: " + defaultAudioDevice);
  ...
  public void start(AudioManagerEvents audioManagerEvents) {
    ...
    if (amState == AudioManagerState.RUNNING) {
      Logging.d(TAG, "AudioManager is already active");
      return;
    }
    ...
    Logging.d(TAG, "AudioManager started, savedAudioMode: " + savedAudioMode);
  }

  @SuppressWarnings("deprecation") // TODO(henrika): audioManager.abandonAudioFocus() is deprecated.
  public void changeAudioRoute(boolean routeToVoiceCall) {
    if (routeToVoiceCall) {
      ...
      audioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        ...
        public void onAudioFocusChange(int focusChange) {
          ...
          Logging.d(TAG, "onAudioFocusChange: " + typeOfChange);
        }
      };
      ...
      Logging.d(TAG, "change audio mode to: " + AudioManager.MODE_IN_COMMUNICATION);
      ...
      Logging.d(TAG, "restore audio mode: " + savedAudioMode);
  ...
  public void stop() {
    ...
    ThreadUtils.checkIsOnMainThread();
    if (amState != AudioManagerState.RUNNING) {
      Logging.d(TAG, "Trying to stop AudioManager in incorrect state: " + amState);
      return;
    }
    amState = AudioManagerState.UNINITIALIZED;
  ...
  private void setAudioDeviceInternal(AudioDevice device) {
    Logging.d(TAG, "setAudioDeviceInternal(device=" + device + ")");
  ...
  public void setDefaultAudioDevice(AudioDevice defaultDevice) {
    ...
    Logging.d(TAG, "setDefaultAudioDevice(device=" + defaultAudioDevice + ")");
    updateAudioDeviceState();
  }
  ...
  public void selectAudioDevice(AudioDevice device) {
    ...
    if (!audioDevices.contains(device)) {
      Logging.e(TAG, "Can not select " + device + " from available " + audioDevices);
    }
  ...
  public void updateAudioDeviceState() {
    ...
    if (bluetoothManager.getState() == AppRTCBluetoothManager.State.HEADSET_AVAILABLE
        || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTING
        || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTED) {
      Logging.d(TAG, "Need BT audio: start=" + needBluetoothAudioStart + ", "
    ...
    if (newAudioDevice != selectedAudioDevice || audioDeviceSetUpdated) {
      ...
      Logging.d(TAG, "New device status: "
                     + "available=" + audioDevices + ", "
