...
namespace AvConf {
AvcfVideoCapturer::AvcfVideoCapturer() = default;
AvcfVideoCapturer::~AvcfVideoCapturer() = default;

void AvcfVideoCapturer::OnFrame(const webrtc::VideoFrame& frame) {
  int cropped_width = 0;
...
rtc::VideoSinkWants AvcfVideoCapturer::GetSinkWants() {
  return broadcaster_.wants();
}

void AvcfVideoCapturer::AddOrUpdateSink(
...
void AvcfVideoCapturer::RemoveSink(
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink) {
  broadcaster_.RemoveSink(sink);
  UpdateVideoAdapter();
}

void AvcfVideoCapturer::OnOutputFormatRequest(int width, int height, int fps) {
...
void AvcfVideoCapturer::UpdateVideoAdapter() {
